      ...
      <div class="col-xl-12">
        <div class="card">
          <div class="card-body">
            ...
            <a href="{{asset('admin/produit/imprimer')}}" target="_blank" style="background: #28a745;float: right;color: #fff;padding: 6px;border-radius: 11px;">imprimer</a>
          </div>
          <div class="imprition">
                ...
                <tbody id="myTable">
                  @foreach ($produits as $produit)
                    ...
                    <tr>
                      ...
                      @endforeach
                      <td>
                      <a href="{{route('produit.edit',$produit->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="border-radius:50%" data-toggle="tooltip" title="Modifier" data-placement="bottom"><i class="fa fa-edit"></i></a>
